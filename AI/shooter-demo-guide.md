...
1. **Основы:**
   - [`beginner-demo-guide.md`](beginner-demo-guide.md) - начните здесь, если ещё не изучили базовые концепции
   - [`atomic-guide-v2.md`](atomic-guide-v2.md) - полное руководство по Atomic Framework

2. **Следующий уровень:**
   - [`rts-demo-guide.md`](rts-demo-guide.md) - продвинутые паттерны, масштабирование, Factory Pattern, Object Pooling

3. **Специализированные темы:**
   - [`presenter-pattern-guide.md`](presenter-pattern-guide.md) - полный гайд по паттерну Presenter для UI (7 типов)
...
```
Beginner Demo → Shooter Demo (вы здесь) → RTS Demo → Собственный проект
```
