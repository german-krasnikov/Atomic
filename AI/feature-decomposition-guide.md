...
1. **Практические примеры:**
   - [`beginner-demo-guide.md`](beginner-demo-guide.md) - пошаговое внедрение фич уровня ⭐ и ⭐⭐
   - [`shooter-demo-guide.md`](shooter-demo-guide.md) - фичи уровня ⭐⭐ и ⭐⭐⭐, иерархия контекстов
   - [`rts-demo-guide.md`](rts-demo-guide.md) - фичи уровня ⭐⭐⭐ и ⭐⭐⭐⭐, продвинутые паттерны

2. **Справочные материалы:**
   - [`atomic-guide-v2.md`](atomic-guide-v2.md) - полное руководство по Atomic Framework
   - [`feature-checklist.md`](feature-checklist.md) - чеклист для определения сложности и проверки фич
