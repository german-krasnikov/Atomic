...
1. **Общие гайды:**
   ...
   - [`feature-checklist.md`](feature-checklist.md) - чеклист для самопроверки при добавлении фич

2. **Продвинутые демо:**
   - [`shooter-demo-guide.md`](shooter-demo-guide.md) - иерархия контекстов (AppContext → GameContext → PlayerContext)
   - [`rts-demo-guide.md`](rts-demo-guide.md) - масштабирование, Factory Pattern, Object Pooling, Burst
...
```
Beginner Demo (вы здесь) → Shooter Demo → RTS Demo → Собственный проект
```
